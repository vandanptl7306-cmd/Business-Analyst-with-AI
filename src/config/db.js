...
const setupMockDB = () => {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    store.invoices.push({
      ...
      buyerPIN: '400001',
      sellerName: 'Business Analyst with AI Store',
      ...
      eInvoiceGeneratedAt: date,
      irn: `irn-hash-${i}-seeded-mock-invoice-nic-portal`,
      qrCodeData: `GSTIN:27BBBBB2222B2Z2*BUYER:27AAAAA1111A1Z1*DOC:INV-26-27-0${10 + i}*AMT:472*IRN:irn-hash-${i}`,
      eWayBillNo: `90812736450${i}`,
      eWayBillStatus: 'Generated',
      eWayBillGeneratedAt: date,
      transporterId: '27TRANS12345678',
