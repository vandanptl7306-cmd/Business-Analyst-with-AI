          ...
          <div style={{ padding: '28px 32px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 28 }}>
              ...
              <div>
                ...
                {/* Bank Details */}
                <div style={{ fontWeight: 700, fontSize: 14, color: '#111827', margin: '24px 0 14px' }}>Bank Details</div>
                <div style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: 8, padding: '16px 18px' }}>
                  <SettingRow checked={printBankDetails} onChange={setPrintBankDetails} label="Print Bank Details on Invoice" info />
                  ...
                  {printBankDetails && (
                    <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 10 }}>
                      ...
                      {/* QR Code Upload / Scanner */}
                      <div style={{ borderTop: '1px solid #F3F4F6', paddingTop: 10, marginTop: 4 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                          <span style={{ fontSize: 13, fontWeight: 600, color: '#374151' }}>Payment QR Code</span>
                          <HelpCircle style={{ width: 13, height: 13, color: '#9CA3AF' }} />
                        </div>

                        {customLogoUrl && printBankDetails ? null : null}
                        ...
                        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                          ...
                          >
                            ...
                            <input type="file" accept="image/*" style={{ display: 'none' }}
                              onChange={e => {
                                ...
                                reader.onload = ev => {
                                  // Store to customLogoUrl for bank QR (we reuse a field for simplicity; you may want a separate field)
                                  // For now, we'll just show a preview. The actual QR data can be stored in storeSettings.
                                };
                          ...
                          <label style={{
                            ...
                            padding: '10px 16px', fontSize: 12, color: '#3B82F6', fontWeight: 600,
